...
#define HUAWEI_PRODUCT_MU609			0x1573	//Added by HuanYi eagle
...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE_AND_INTERFACE_INFO(HUAWEI_VENDOR_ID, HUAWEI_PRODUCT_MU609, 0xff, 0xff, 0xff),
		.driver_info = (kernel_ulong_t) &huawei_cdc12_blacklist},//Added by HuanYi eagle
